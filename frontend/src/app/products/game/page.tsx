      ...
      <div className="container-custom px-4 max-w-6xl mx-auto">
        ...
        <div className="text-center mb-8">
          ...
          <ThaiText className="text-gray-600 mb-6">
            เลือกหมวดหมู่เกมที่ต้องการ แต่ละหมวดหมู่มีสินค้าหลากหลายให้เลือก
          </ThaiText>
          ...
          <div className="mt-8 text-center">
            <div className="bg-white rounded-lg p-6 shadow-sm">
              <ThaiText className="text-gray-600">
                รวมทั้งหมด <span className="font-bold text-primary-600">{gameCategories.length}</span> หมวดหมู่ 
                และ <span className="font-bold text-primary-600">{gameProducts?.length || 0}</span> สินค้า
              </ThaiText>
            </div>
          </div>
        )}
