...
import { HomeIcon, ArrowLeftIcon, DevicePhoneMobileIcon } from '@heroicons/react/24/outline'
...
export default function MobileCategoryPage() {
  ...
  const categoryProducts = useMemo(() => {
    ...
    return mobileProducts.filter(product => 
      (product.category || 'อื่นๆ') === categoryName
    )
  }, [mobileProducts, categoryName])
      ...
      <div className="container-custom px-4 max-w-6xl mx-auto">
        ...
        <div className="text-center mb-8">
          ...
          <ThaiText className="text-gray-600 mb-6">
            สินค้าเติมเงินมือถือในหมวดหมู่ {categoryName} ทั้งหมด {categoryProducts.length} รายการ
          </ThaiText>
          ...
          <div className="flex justify-center gap-2">
            <Button variant="outline" size="sm" asChild>
              ...
              >
                ...
                <span className="leading-none">กลับหมวดหมู่เติมเงินมือถือ</span>
              </Link>
            </Button>
            <Button variant="outline" size="sm" asChild>
              <Link 
        ...
        {categoryProducts.length > 0 ? (
          ...
          <div className="text-center py-12">
            ...
            <ThaiText className="text-gray-400 mb-6">
              ขณะนี้ยังไม่มีสินค้าเติมเงินมือถือในหมวดหมู่ "{categoryName}"
            </ThaiText>
